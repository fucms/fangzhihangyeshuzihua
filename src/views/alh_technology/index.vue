        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="物料名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入物料名称"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="物料名称" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="型号" prop="type1" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="材质" prop="type1" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
