    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="采购物品">
          <el-input v-model="listQuery.filter" placeholder="请输入采购物品" />
        </el-form-item>
        <el-form-item label="申请人">
          <el-input v-model="listQuery.filter" placeholder="请输入申请人" />
        </el-form-item>
        <el-form-item label="申请日期">
          <el-input v-model="listQuery.filter" placeholder="请输入申请日期" />
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <el-table-column label="采购物品" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="价格" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="数量" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="申请人" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="申请日期" prop="type1" align="center">
          <span>2023-11-11</span>
        </el-table-column>
        <el-table-column label="定价" prop="address" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="总价" prop="address" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
