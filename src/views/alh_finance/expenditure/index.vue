    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="账户信息">
          <el-input v-model="listQuery.filter" placeholder="请输入账户信息" />
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <el-table-column label="账户信息" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="金额" prop="address" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="支出日期" prop="address" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
