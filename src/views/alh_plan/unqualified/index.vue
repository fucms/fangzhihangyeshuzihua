  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      >
        ...
        <el-table-column label="不合格原因" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="评审结果" prop="code" align="center">
          <template slot-scope="{ row }">
            <el-tag :type="row.type == 1 ?'success':'danger'">{{ row.type == 1 ? '合格' : '不合格' }}</el-tag>
          </template>
        </el-table-column>
