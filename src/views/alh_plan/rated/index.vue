    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item label="生产数量">
          <el-input v-model="listQuery.filter" placeholder="请输入生产数量" />
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <el-table-column label="生产数量" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="生产率" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="故障率" prop="type1" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="加工时间" prop="type1" align="center">
